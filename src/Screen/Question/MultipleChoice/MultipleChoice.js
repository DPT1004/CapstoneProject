        ...
        <View style={styles.container}>
            {
                isLoading ?
                    ...
                    <ScrollView
                        ...
                        <Text style={styles.title}>MultipleChoice</Text>
                                        ...
                                        <View style={styles.containerBtnIcons}>
                                            ...
                                            <Icon1
                                                ...
                                                onPress={() => {
                                                    ...
                                                    let newArrAnswer = [...arrAnswer]
                                                    let indexAnswerCorrectBefore = newArrAnswer.findIndex((item) => item.isCorrect == true)
                                                    newArrAnswer[indexAnswerCorrectBefore] = {
                                                        ...newArrAnswer[indexAnswerCorrectBefore],
                                                        isCorrect: false
                                                    }
                                                    newArrAnswer[index] = {
